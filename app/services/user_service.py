...
class UserService:
    ...
    async def autenticate_user(self, data_user: User):
        ...
        try:
            ...
            if is_valid:
                ...
                return await saim_api_response.create_response(False, None, 'Usuário sem acesso ao sistema')
        except IntegrityError as error:
            return await saim_api_response.create_response(False, None, f"Erro na autenticação do usuário. tente novamente. ERRO: {error}")
    ...
    async def post_user(self, data_user: User):
        ...
        try:
            ...
            return await saim_api_response.create_response(False, None, f"Erro na encriptação da senha. tente novamente. ERRO: {error}")
    ...
    async def post_user_full(self, data_user_full: UserFull):
        ...
        try:
            ...
            if is_valid:
                ...
                return await saim_api_response.create_response(False, None, 'Senhas inválidas')
        except IntegrityError as error:
